...
define config.mouse = {
    "default" : [("gui/mouse_custom.png", 2, 0)]
    }
...
define gui.accent_color = u'#7d4c99'
...
define gui.hover_color = u'#a373bf'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = u'#7d4c99'
...
define gui.interface_text_size = 31
...
define gui.button_text_idle_color = gui.text_color
